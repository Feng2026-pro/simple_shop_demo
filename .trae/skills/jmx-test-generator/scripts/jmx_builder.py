...
class JMXBuilder:
    ...
    def create_test_plan(self, test_plan_name: str = "Test Plan", 
        ...
        # 测试计划属性
        bool_prop = ET.SubElement(self.test_plan, "boolProp", name="TestPlan.functional_mode")
        bool_prop.text = "false"
        
        bool_prop = ET.SubElement(self.test_plan, "boolProp", name="TestPlan.serialize_threadgroups")
        bool_prop.text = "false"
        ...
        if user_defined_variables:
            for key, value in user_defined_variables.items():
                ...
                string_prop_name = ET.SubElement(element_prop_var, "stringProp", name="Argument.name")
                string_prop_name.text = key
                string_prop_value = ET.SubElement(element_prop_var, "stringProp", name="Argument.value")
                string_prop_value.text = str(value)
                string_prop_meta = ET.SubElement(element_prop_var, "stringProp", name="Argument.metadata")
                string_prop_meta.text = "="
        
        string_prop = ET.SubElement(self.test_plan, "stringProp", name="TestPlan.user_define_classpath")
        string_prop.text = ""
    ...
    def add_http_request(self, parent_hash_tree: ET.Element, name: str, domain: str, 
        ...
        string_prop = ET.SubElement(http_sampler, "stringProp", name="HTTPSampler.domain")
        string_prop.text = domain
        
        string_prop = ET.SubElement(http_sampler, "stringProp", name="HTTPSampler.port")
        string_prop.text = str(port)
        
        string_prop = ET.SubElement(http_sampler, "stringProp", name="HTTPSampler.protocol")
        string_prop.text = protocol
        
        string_prop = ET.SubElement(http_sampler, "stringProp", name="HTTPSampler.contentEncoding")
        string_prop.text = ""
        
        string_prop = ET.SubElement(http_sampler, "stringProp", name="HTTPSampler.path")
        string_prop.text = path
        
        string_prop = ET.SubElement(http_sampler, "stringProp", name="HTTPSampler.method")
        string_prop.text = method
        
        bool_prop = ET.SubElement(http_sampler, "boolProp", name="HTTPSampler.follow_redirects")
        bool_prop.text = "true"
        
        bool_prop = ET.SubElement(http_sampler, "boolProp", name="HTTPSampler.auto_redirects")
        bool_prop.text = "false"
        
        bool_prop = ET.SubElement(http_sampler, "boolProp", name="HTTPSampler.use_keepalive")
        bool_prop.text = "true"
        
        bool_prop = ET.SubElement(http_sampler, "boolProp", name="HTTPSampler.DO_MULTIPART_POST")
        bool_prop.text = "false"
        
        string_prop = ET.SubElement(http_sampler, "stringProp", name="HTTPSampler.embedded_url_re")
        string_prop.text = ""
        
        string_prop = ET.SubElement(http_sampler, "stringProp", name="HTTPSampler.connect_timeout")
        string_prop.text = ""
        
        string_prop = ET.SubElement(http_sampler, "stringProp", name="HTTPSampler.response_timeout")
        string_prop.text = ""
        ...
        if body and method.upper() in ['POST', 'PUT', 'PATCH']:
            # 更新 Arguments 以包含 body
            element_prop = ET.SubElement(http_sampler, "boolProp", name="HTTPSampler.postBodyRaw")
            element_prop.text = "true"
            # 在 Arguments 中添加 body
    ...
    def add_response_assertion(self, parent_hash_tree: ET.Element, name: str, 
        ...
        string_prop = ET.SubElement(collection_prop, "stringProp", name="49586")
        ...
        string_prop.text = field_to_test
